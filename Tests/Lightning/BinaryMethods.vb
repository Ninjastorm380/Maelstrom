Public Module BinaryMethods
    ...
    Public Sub PackTimestamp(ByRef Buffer as Byte(), Byval Offset as Int32, Byref Data as DateTime)
    ...
    Public Sub UnpackTimestamp(Byref Buffer as Byte(), Byval Offset as Int32, ByRef Data as DateTime)
    ...
    Public Function UnpackTimestamp(Byref Buffer as Byte(), Byval Offset as Int32) As DateTime
        Dim Year As Int32 = BitConverter.ToInt32(Buffer, Offset + 0)
        Dim Month As Int32 = BitConverter.ToInt32(Buffer, Offset + 4)
        Dim Day As Int32 = BitConverter.ToInt32(Buffer, Offset + 8) 
        Dim Hour As Int32 = BitConverter.ToInt32(Buffer, Offset + 12)
    ...
    Public Sub UnpackUInt32(Byref Buffer as Byte(), Byval Offset as Int32, Byref Data as UInt32)
